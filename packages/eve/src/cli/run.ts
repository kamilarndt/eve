...
import { collectHeaderOption, parseHeaderOptions } from "#cli/header-option.js";
...
function createCliProgram(logger: CliLogger, runtime: CliRuntimeOverrides): Command {
  ...
  program
    ...
    .option("--header <name:value>", "Header sent with remote TUI requests", collectHeaderOption)
    .option(
      "--tools <mode>",
